  ...
  return (
    <Card className="rounded-2xl shadow-xl bg-white/80 backdrop-blur-sm border-white/20">
      <CardHeader className="text-center pb-6">
        <CardTitle className="text-2xl font-bold gradient-text">Formatação ABNT pronta</CardTitle>
        <p className="text-muted-foreground">Seu TCC formatado conforme as normas acadêmicas</p>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border-2 border-dashed border-gray-300">
          <div className="text-center space-y-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-gray-700">Pré-visualização do TCC</h3>
              <p className="text-gray-500 text-sm">Documento formatado em ABNT com 45 páginas</p>
            </div>
            <div className="bg-white rounded-xl p-4 text-left text-xs text-gray-600 max-w-md mx-auto shadow-sm">
              <div className="space-y-2">
                <div className="font-bold text-center">UNIVERSIDADE FEDERAL</div>
                <div className="text-center">CURSO DE ADMINISTRAÇÃO</div>
                <div className="h-8"></div>
                <div className="font-bold text-center">JOÃO DA SILVA</div>
                <div className="h-8"></div>
                <div className="font-bold text-center">ANÁLISE DO COMPORTAMENTO DO CONSUMIDOR...</div>
                <div className="text-center text-xs">Trabalho de Conclusão de Curso...</div>
              </div>
            </div>
          </div>
        </div>
        <div className="grid md:grid-cols-2 gap-4">
          <Button className="p-6 h-auto rounded-2xl gradient-bg text-white hover:scale-105 hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <div className="text-sm opacity-90">Versão final para impressão</div>
            </div>
          </Button>
          <Button
            variant="outline"
          ...
          >
            <div className="text-center">
              ...
              <div className="text-sm text-purple-600">Para edições adicionais</div>
            </div>
          </Button>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
          <h3 className="font-semibold text-blue-900 mb-3">✅ Seu TCC inclui:</h3>
